        ...
        foreach ($data as $row) {
            ...
            if (!empty($lotNo)) {
                ...
                if ($check_result->num_rows > 0) {
                    ...
                    $sql_insert_stock = "INSERT INTO `stock_list`(`lot_no`, `shape`, `size`, `pcs`, `weight`, `color`, `clarity`, `certificate_no`, `rap`, `discount`, `memo_date`) 
                    VALUES ('$lotNo','$shape','$size','$pcs','$wt','$color','$clarity','$certificate','$rap','$disc', '$date')";
                }
